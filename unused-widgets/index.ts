...
// import { AvatarPicker } from '../../../unused-widgets/AvatarPicker';
// import { PainMap } from '../../../unused-widgets/PainMap';
// import { PatientDemographics } from '../../../unused-widgets/PatientDemographics';
// import { AssessmentScale } from '../../../unused-widgets/AssessmentScale';
...
export { default as AvatarPickerDefault } from '../../../unused-widgets/AvatarPicker';
export { default as PainMapDefault } from '../../../unused-widgets/PainMap';
export { default as PatientDemographicsDefault } from '../../../unused-widgets/PatientDemographics';
export { default as AssessmentScaleDefault } from '../../../unused-widgets/AssessmentScale';
...
export const WIDGET_REGISTRY = {
  ...
  AssessmentScale: {
    description: 'Validated clinical assessment questionnaires with auto-scoring',
    props: {
      ...
      value: 'Record<string, number> (optional)',
      className: 'string (optional)'
    },
    use_cases: [
      'Depression screening (PHQ-9)',
      'Anxiety assessment (GAD-7)',
      'ADHD evaluation (Vanderbilt scales)',
    ...
    clinical_features: [
      ...
      'Suicidal ideation detection (PHQ-9)'
    ],
